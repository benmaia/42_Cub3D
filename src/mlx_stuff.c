...
{
	mlx->textures[0].img_ptr = mlx_xpm_file_to_image(mlx->ptr, mlx->m->texture[0], &mlx->textures[0].w, &mlx->textures[0].h);
	...
	mlx->textures[1].img_ptr = mlx_xpm_file_to_image(mlx->ptr, mlx->m->texture[1], &mlx->textures[1].w, &mlx->textures[1].h);
	...
	mlx->textures[2].img_ptr = mlx_xpm_file_to_image(mlx->ptr, mlx->m->texture[2], &mlx->textures[2].w, &mlx->textures[2].h);
	...
	mlx->textures[3].img_ptr = mlx_xpm_file_to_image(mlx->ptr, mlx->m->texture[3], &mlx->textures[3].w, &mlx->textures[3].h);
