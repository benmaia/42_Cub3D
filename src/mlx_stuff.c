...
{
	mlx->textures[0].img_ptr = mlx_xpm_file_to_image(mlx->ptr,"./assets/siding3.xpm", &mlx->textures[0].w, &mlx->textures[0].h);
	...
	mlx->textures[1].img_ptr = mlx_xpm_file_to_image(mlx->ptr,"./assets/siding5.xpm", &mlx->textures[1].w, &mlx->textures[1].h);
	...
	mlx->textures[2].img_ptr = mlx_xpm_file_to_image(mlx->ptr,"./assets/siding4.xpm", &mlx->textures[2].w, &mlx->textures[2].h);
	...
	mlx->textures[3].img_ptr = mlx_xpm_file_to_image(mlx->ptr,"./assets/siding6.xpm", &mlx->textures[3].w, &mlx->textures[3].h);
